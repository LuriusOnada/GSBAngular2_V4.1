...
import {MedicamentsComponent} from "./medicaments/app.medicaments.component";
...
@NgModule({
  ...
  declarations: [ AppComponent,ConnexionComponent,MedecinsComponent, VisitesComponent,NavbarComponent, MedicamentsComponent, ],
